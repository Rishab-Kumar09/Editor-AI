    ...
    <div className="space-y-10">
      ...
      <div className="mx-auto bg-surfacePrimary max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
        ...
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-white-900 sm:text-7xl">
          <span className="inline-block">Editor
            <span className="relative whitespace-nowrap text-white-600">
              ...
              <span className="relative">AI</span></span>
          </span>
        </h1>
        ...
        <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
          ...
          <div className="relative flex flex-1 flex-col items-stretch sm:flex-none">
            <Link href="/settings" as={"/settings"}
              className="rounded-full bg-blue-600 border border-solid border-transparent transition-colors flex items-center justify-center text-white gap-2 hover:bg-blue-700 font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <span className="ml-3">⚙️ AI Settings</span>
            </Link>
          </div>
          <Link href="https://github.com/Rishab-Kumar09/Editor-AI" target="_blank"
